                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="w-full px-4 py-3 text-center text-gray-100 bg-[#57b7aa] border border-transparent dark:border-gray-700 rounded-lg">Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
