...
const UserDashboard = () => {
    ...
    return (
            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-[#92e3d8] py-5 rounded-xl border border-[#57b7aa]">
                        {/* image  */}
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-[#57b7aa] md:flex-row">
                                                {/* main 3  */}
                                                <div className="w-full border-r border-[#57b7aa] bg-[#92e3d8] md:max-w-xs">
                                                    {/* left  */}
                                                    <div className="p-8">
